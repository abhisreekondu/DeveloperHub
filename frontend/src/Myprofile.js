...
const Myprofile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get('http://localhost:5000/myreview', { headers })
  ...
  return (
    <div>
      ...
      <section>
        ...
        {data && (
          <><h2 className='text-primary text-center p-3'>MY PROFILE</h2><div className='card1'>
            <img
              className='userimg'
            ...
            <div className="profile-details">
              <h4 className="profile-name">Name: {data.name}</h4>
              <h6 className="profile-email">Email: {data.email}</h6>
              <h6 className="profile-mobile">Mobile: {data.mobile}</h6>
...
<div className="heading1">
      ...
      <h3 className="text-primary fw-bold heading-text">My Ratings</h3>
    </div>
          ...
          <div className="reviews-box1">
            {review.length>0  ? (
              review.map((review )=> (
                ...
                <div key={review._id}  className="review-item1">
